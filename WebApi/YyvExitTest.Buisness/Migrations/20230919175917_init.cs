...
namespace YYvMiniProject.Buisness.Migrations
{
    /// <inheritdoc />
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_carCollections", x => x.Vehicle_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_carRentalAgreements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_carRentalAgreements_carCollections_CarId",
                        column: x => x.CarId,
                        principalTable: "carCollections",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_carRentalAgreements_CarId",
